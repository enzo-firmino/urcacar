 ...
 */
final class Version20210126131846 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, ville VARCHAR(255) NOT NULL, cp INT NOT NULL, adresse VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, envoyeur_id INT NOT NULL, destinataire_id INT NOT NULL, texte VARCHAR(255) NOT NULL, date DATE NOT NULL, vu TINYINT(1) DEFAULT NULL, INDEX IDX_B6BD307F4795A786 (envoyeur_id), INDEX IDX_B6BD307FA4F84F6E (destinataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', prenom VARCHAR(255) NOT NULL, telephone INT DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, rang INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, fiabilite INT DEFAULT NULL, res_acceptee TINYINT(1) DEFAULT NULL, res_envoyee TINYINT(1) DEFAULT NULL, demande_res TINYINT(1) DEFAULT NULL, trajet_imminent TINYINT(1) DEFAULT NULL, trajet_annule TINYINT(1) DEFAULT NULL, demande_notation TINYINT(1) DEFAULT NULL, nouvel_avis TINYINT(1) DEFAULT NULL, dialogue TINYINT(1) DEFAULT NULL, fumer TINYINT(1) DEFAULT NULL, musique TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98C305689D FOREIGN KEY (adresse_depart_id) REFERENCES adresse (id)');
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98C85ED0E35 FOREIGN KEY (adresse_arrivee_id) REFERENCES adresse (id)');
