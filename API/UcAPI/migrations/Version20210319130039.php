 ...
 */
final class Version20210319130039 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, envoyeur_id INT NOT NULL, destinataire_id INT NOT NULL, texte VARCHAR(255) NOT NULL, date DATETIME NOT NULL, vu TINYINT(1) DEFAULT NULL, INDEX IDX_B6BD307F4795A786 (envoyeur_id), INDEX IDX_B6BD307FA4F84F6E (destinataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reserver ADD CONSTRAINT FK_B9765E9371A51189 FOREIGN KEY (passager_id) REFERENCES utilisateur (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reserver ADD CONSTRAINT FK_B9765E93D12A823 FOREIGN KEY (trajet_id) REFERENCES trajet (id) ON DELETE CASCADE');
